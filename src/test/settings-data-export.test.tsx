...
describe('Settings / Data canonical export page', () => {
  ...
  it('keeps Settings as one page with export, privacy, and prototype boundary sections', () => {
    ...
    expect(screen.getByText(/确定性的去标识 fixture 路径/)).toBeInTheDocument()
    expect(screen.getByText(/不是生产级 OCR/)).toBeInTheDocument()
    expect(screen.getByText(/OCR 技术验证是独立工作/)).toBeInTheDocument()
